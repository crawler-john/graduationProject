...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_addTask_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 34, 21)
    ...
    "addTask\0sigAddProTaskInfoSuccess\0\0"
...
void addTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        addTask *_t = static_cast<addTask *>(_o);
        switch (_id) {
        case 0: _t->sigAddProTaskInfoSuccess(); break;
        ...
        {
            typedef void (addTask::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&addTask::sigAddProTaskInfoSuccess)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject addTask::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_addTask.data,
      qt_meta_data_addTask,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_addTask.stringdata))
        return static_cast<void*>(const_cast< addTask*>(this));
...
// SIGNAL 0
void addTask::sigAddProTaskInfoSuccess()
{
